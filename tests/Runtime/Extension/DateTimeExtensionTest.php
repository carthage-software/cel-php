...
final class DateTimeExtensionTest extends RuntimeTestCase
{
    ...
    public static function provideEvaluationCases(): iterable
    {
        ...
        yield 'DateTime getHours(): timestamp UTC' => [
            'getHours(timestamp("2025-09-13T10:20:30Z"))',
            [],
            new IntegerValue(10),
        ];
        ...
        yield 'DateTime getMinutes(): timestamp UTC' => [
            'getMinutes(timestamp("2025-09-13T10:20:30Z"))',
            [],
            new IntegerValue(20),
        ];
        ...
        yield 'DateTime getSeconds(): timestamp UTC' => [
            'timestamp("2025-09-13T10:20:30Z").getSeconds()',
            [],
            new IntegerValue(30),
        ];
        ...
        yield 'DateTime getFullYear(): timestamp UTC' => [
            'getFullYear(timestamp("2025-09-13T10:00:00Z"))',
            [],
        ...
        yield 'DateTime getMonth(): timestamp UTC (September is 8)' => [
            'getMonth(timestamp("2025-09-13T10:00:00Z"))',
            [],
            new IntegerValue(8),
        ];
        ...
        yield 'DateTime getDayOfYear(): timestamp UTC' => [
            'getDayOfYear(timestamp("2025-01-10T10:00:00Z"))',
            [],
            new IntegerValue(9),
        ];
        ...
        yield 'DateTime getDayOfWeek(): Sunday is 0' => [
            'getDayOfWeek(timestamp("2025-09-14T10:00:00Z"))',
            [],
            new IntegerValue(0),
        ];
        yield 'DateTime getDayOfWeek(): Saturday is 6' => [
            'getDayOfWeek(timestamp("2025-09-13T10:00:00Z"))',
            [],
            new IntegerValue(6),
        ];
