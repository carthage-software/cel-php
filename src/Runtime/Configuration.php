...
use Cel\Interpreter\Macro\ExistsOneTwoVarMacro;
...
use Cel\Interpreter\Macro\TransformListMacro;
use Cel\Interpreter\Macro\TransformMapMacro;
...
final class Configuration implements DefaultInterface
{
    ...
    public function __construct(
        ...
        if ($enableMacros) {
            ...
            $this->macroRegistry->register(new ExistsOneTwoVarMacro());
            $this->macroRegistry->register(new TransformListMacro());
            $this->macroRegistry->register(new TransformMapMacro());
