...
final readonly class NullNullHandler implements BinaryOperatorOverloadHandlerInterface
{
    ...
    {
        $left = OperandUtil::assertLeft($left, NullValue::class);
        $right = OperandUtil::assertRight($right, NullValue::class);
