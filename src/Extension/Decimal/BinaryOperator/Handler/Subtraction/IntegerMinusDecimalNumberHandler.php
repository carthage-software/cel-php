...
/**
 * Handles subtraction of a DecimalNumber from an Integer.
 */
final readonly class IntegerMinusDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of subtracting the DecimalNumber from the Integer.
     *
