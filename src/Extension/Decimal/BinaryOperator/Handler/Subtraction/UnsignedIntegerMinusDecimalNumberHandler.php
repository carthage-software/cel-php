...
/**
 * Handles subtraction of a DecimalNumber from an UnsignedInteger.
 */
final readonly class UnsignedIntegerMinusDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of subtracting the DecimalNumber from the UnsignedInteger.
     *
