...
/**
 * Handles addition of a DecimalNumber and an UnsignedInteger.
 */
final readonly class DecimalNumberPlusUnsignedIntegerHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of adding the DecimalNumber and UnsignedInteger.
     *
