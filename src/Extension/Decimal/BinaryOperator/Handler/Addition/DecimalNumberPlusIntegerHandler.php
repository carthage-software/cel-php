...
/**
 * Handles addition of a DecimalNumber and an Integer.
 */
final readonly class DecimalNumberPlusIntegerHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of adding the DecimalNumber and Integer.
     *
