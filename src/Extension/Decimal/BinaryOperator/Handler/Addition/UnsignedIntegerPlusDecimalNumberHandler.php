 ...
 */
final readonly class UnsignedIntegerPlusDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of adding the UnsignedInteger and DecimalNumber.
     *
