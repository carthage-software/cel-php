...
/**
 * Handles addition of a DecimalNumber and a Float.
 */
final readonly class DecimalNumberPlusFloatHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of adding the DecimalNumber and Float.
     *
