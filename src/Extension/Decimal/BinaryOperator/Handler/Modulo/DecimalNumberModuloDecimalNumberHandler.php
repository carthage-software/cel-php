...
/**
 * Handles modulo operation of two DecimalNumber values.
 */
final readonly class DecimalNumberModuloDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of the modulo operation of the two DecimalNumber values.
     *
    ...
    public function __invoke(BinaryExpression $expression, Value $left, Value $right): Value
    {
        ...
        try {
            $result = $left->message->getInner()->mod($right->message->getInner());
        } catch (Throwable $e) {
