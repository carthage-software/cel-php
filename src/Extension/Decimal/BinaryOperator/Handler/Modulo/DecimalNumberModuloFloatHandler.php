...
/**
 * Handles modulo operation of a DecimalNumber and a Float.
 */
final readonly class DecimalNumberModuloFloatHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of the modulo operation of the DecimalNumber and Float.
     *
