...
/**
 * Handles modulo operation of a Float and a DecimalNumber.
 */
final readonly class FloatModuloDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of the modulo operation of the Float and DecimalNumber.
     *
