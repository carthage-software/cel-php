...
/**
 * Handles equality comparison of a DecimalNumber and an UnsignedInteger.
 */
final readonly class DecimalNumberEqualsUnsignedIntegerHandler implements BinaryOperatorOverloadHandlerInterface
{
     ...
     *
     * @return Value The result of comparing equality of the DecimalNumber and UnsignedInteger.
     *
    ...
    public function __invoke(BinaryExpression $expression, Value $left, Value $right): Value
    {
        ...
        try {
            $equals = $left->message->getInner()->equals(DecimalFactory::from((string) $right->value));
        } catch (Throwable $e) {
