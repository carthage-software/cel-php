 ...
 */
final readonly class IntegerEqualsDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
     ...
     *
     * @return Value The result of comparing equality of the Integer and DecimalNumber.
     *
