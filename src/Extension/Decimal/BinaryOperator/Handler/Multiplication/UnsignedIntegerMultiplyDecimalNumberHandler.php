...
/**
 * Handles multiplication of an UnsignedInteger and a DecimalNumber.
 */
final readonly class UnsignedIntegerMultiplyDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of multiplying the UnsignedInteger and DecimalNumber.
     *
