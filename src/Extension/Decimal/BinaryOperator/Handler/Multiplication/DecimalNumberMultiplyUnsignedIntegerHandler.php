...
/**
 * Handles multiplication of a DecimalNumber and an UnsignedInteger.
 */
final readonly class DecimalNumberMultiplyUnsignedIntegerHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of multiplying the DecimalNumber and UnsignedInteger.
     *
