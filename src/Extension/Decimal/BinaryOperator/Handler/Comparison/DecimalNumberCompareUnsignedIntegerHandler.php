...
/**
 * Handles comparison of a DecimalNumber and an UnsignedInteger.
 */
final readonly class DecimalNumberCompareUnsignedIntegerHandler implements BinaryOperatorOverloadHandlerInterface
{
     ...
     *
     * @return Value The result of comparing the DecimalNumber and UnsignedInteger.
     *
