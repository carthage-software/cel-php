 ...
 */
final readonly class UnsignedIntegerCompareDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
     ...
     *
     * @return Value The result of comparing the UnsignedInteger and DecimalNumber.
     *
