...
/**
 * Handles comparison of a DecimalNumber and an Integer.
 */
final readonly class DecimalNumberCompareIntegerHandler implements BinaryOperatorOverloadHandlerInterface
{
     ...
     *
     * @return Value The result of comparing the DecimalNumber and Integer.
     *
