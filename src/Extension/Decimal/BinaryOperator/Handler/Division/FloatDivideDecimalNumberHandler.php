...
/**
 * Handles division of a Float by a DecimalNumber.
 */
final readonly class FloatDivideDecimalNumberHandler implements BinaryOperatorOverloadHandlerInterface
{
    /**
     ...
     *
     * @return Value The result of dividing the Float by the DecimalNumber.
     *
